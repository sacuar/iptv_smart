...
<table>
  ...
  <tbody>
    <tr><td>Animation</td><td align="right">53</td><td nowrap><code>https://iptv-org.github.io/iptv/categories/animation.m3u</code><button id="copyBlock">Click to copy</button> <span id="copyAnswer"></span></td></tr>
